...
make -j$(nproc)
sudo make install
sudo cp -r /usr/local/lib/python3.12/site-packages/cv2/ /home/steffenr/.local/lib/python3.12/site-packages/ #For anyone else using this, change you paths accordingly. If you are updating versions you might need to include tis line.
